package com.xakcch.common.utils.file;
...
import com.xakcch.common.exception.file.FileNameLengthLimitExceededException;
import com.xakcch.common.exception.file.FileSizeLimitExceededException;
import com.xakcch.common.exception.file.InvalidExtensionException;
...
import com.xakcch.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
    ...
    private static String defaultBaseDir = LandPatchConfig.getProfile();
     ...
     * @return 返回上传成功的文件名
     * @throws FileSizeLimitExceededException 如果超过最大大小
    ...
    {
        int dirLastIndex = LandPatchConfig.getProfile().length() + 1;
