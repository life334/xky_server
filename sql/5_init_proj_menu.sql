...
INSERT INTO sys_menu VALUES (11, '历史数据导入', 0, 1, 'import', 'project/import/index', '', 'Import', 1, 0, 'C', '0', '0', 'project:import:view', 'build', 'admin', now(), '', NULL, '历史数据批量导入');
...
INSERT INTO sys_menu VALUES (1102, '项目办结', 503, 6, '', '', '', '', 1, 0, 'F', '0', '0', 'project:project:complete', '#', 'admin', now(), '', NULL, '');
...
INSERT INTO sys_menu VALUES (1111, '资料领取', 6, 6, '', '', '', '', 1, 0, 'F', '0', '0', 'project:material:borrow', '#', 'admin', now(), '', NULL, '');
INSERT INTO sys_menu VALUES (1112, '资料归还', 6, 7, '', '', '', '', 1, 0, 'F', '0', '0', 'project:material:return', '#', 'admin', now(), '', NULL, '');

-- 费用结算按钮
INSERT INTO sys_menu VALUES (1097, '费用结算查询', 7, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'project:settlement:query', '#', 'admin', now(), '', NULL, '');
INSERT INTO sys_menu VALUES (1098, '费用结算新增', 7, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'project:settlement:add', '#', 'admin', now(), '', NULL, '');
...
-- 动态字段按钮
INSERT INTO sys_menu VALUES (1106, '动态字段查询', 510, 1, '', '', '', '', 1, 0, 'F', '0', '0', 'system:fieldDef:query', '#', 'admin', now(), '', NULL, '');
INSERT INTO sys_menu VALUES (1107, '动态字段新增', 510, 2, '', '', '', '', 1, 0, 'F', '0', '0', 'system:fieldDef:add', '#', 'admin', now(), '', NULL, '');
