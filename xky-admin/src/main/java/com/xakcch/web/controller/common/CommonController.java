...
import com.xakcch.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            {
                throw new Exception(StringUtils.format("文件名({})非法，不允许下载。", fileName));
            }
            String realFileName = System.currentTimeMillis() + fileName.substring(fileName.indexOf("_") + 1);
            String filePath = LandPatchConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        try
        {
            String filePath = LandPatchConfig.getUploadPath();
            ...
            throws Exception
    {
        try
        {
            ...
            String localPath = LandPatchConfig.getProfile();
